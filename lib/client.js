...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var PLUGIN_VERSION = "1.3.0"; // keep in sync with package.json
...
.cp-quick { display: flex; flex-wrap: wrap; gap: 8px; align-items: center; }
...
.cp-toolbar {
  ...
  background: var(--cp-surface); border: 1px solid var(--cp-line); border-radius: var(--cp-radius);
}
...
.cp-feihua { width: 58px; text-align: center; }
.cp-select:focus, .cp-author-input:focus, .cp-feihua:focus { border-color: var(--dsw-alias-brand-primary); outline: none; }
.cp-feihua-group {
  display: inline-flex; gap: 6px; align-items: center;
  padding: 3px 4px 3px 10px; border: 1px solid var(--cp-line);
  border-radius: 999px; background: var(--cp-surface-2);
}
.cp-feihua-label { font-size: 12px; color: var(--cp-muted); white-space: nowrap; }
.cp-feihua-group .cp-feihua, .cp-feihua-group .cp-btn { border: 0; background: transparent; }
.cp-feihua-group .cp-feihua { width: 46px; padding: 4px 2px; }
.cp-feihua-group .cp-btn { padding: 4px 12px; font-size: 12.5px; border-radius: 999px; }
.cp-chips {
